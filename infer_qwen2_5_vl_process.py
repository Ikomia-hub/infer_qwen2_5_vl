...
# --------------------
class InferQwen25VlParam(core.CWorkflowTaskParam):
...
# --------------------
class InferQwen25Vl(dataprocess.C2dImageTask):
    ...
    def __init__(self, name, param):
        ...
        if param is None:
            self.set_param_object(InferQwen25VlParam())
        else:
...
# --------------------
class InferQwen25VlFactory(dataprocess.CTaskFactory):
    ...
    def __init__(self):
        ...
        self.info.authors =     "Bai, Shuai and Chen, Keqin and Liu, Xuejing and Wang, Jialin and Ge, " \
                                ...
                                "Zhaohai and Wan, Jianqiang and Wang, Pengfei and Ding, Wei and Fu, " \
                                "Zheren and Xu, Yiheng and Ye, Jiabo and Zhang, Xi and Xie, Tianbao and Cheng, " \
                                "Zesen and Zhang, Hang and Yang, Zhibo and Xu, Haiyang and Lin, Junyang"
        self.info.article = "Qwen2.5-VL Technical Report"
        self.info.journal = "arXiv:2502.13923"
        self.info.year = 2025
    ...
    def create(self, param=None):
        ...
        return InferQwen25Vl(self.info.name, param)
